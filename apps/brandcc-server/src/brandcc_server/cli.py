"""brandcc_server CLI — administrative commands.

Usage:
    python -m brandcc_server.cli create-key --name admin --superuser
    python -m brandcc_server.cli create-key --name regular_user
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="brandcc_server.cli", description="brandcc_server admin CLI"
    )
