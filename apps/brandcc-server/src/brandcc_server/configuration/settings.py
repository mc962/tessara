"""Configuration management for BrandCC."""
...
class SqliteDatabaseSettings(DatabaseSettingsBase):
    ...
    path: Path | Literal[":memory:"] = Path(
        os.path.join(PROJECT_ROOT, "data", "brandcc.db")
    )
...
class Common(BaseSettings):
    project_name: str = "BrandCC"
    page_title: str = "BrandCC"
    ...
    def application_version(self) -> str:
        try:
            ...
            pass
        try:
            return importlib.metadata.version("brandcc-server")
