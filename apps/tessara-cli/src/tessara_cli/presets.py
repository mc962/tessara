...
# Deliberately duplicated from tessara-core's copy at
# packages/tessara-core/src/tessara/presets.py, not imported: tessara-cli's
# base install has no dependency on tessara-core (only the "local" extra does),
