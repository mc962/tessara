"""tessera_server CLI — administrative commands.

Usage:
    python -m tessera_server.cli create-key --name admin --superuser
    python -m tessera_server.cli create-key --name regular_user
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="tessera_server.cli", description="tessera_server admin CLI"
    )
