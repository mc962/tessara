...
name = "Tessera on FastAPI framework on Gunicorn web server"

wsgi_app = "tessera_server.main:app"
...
# Single worker for now. If tessera-server grows in-process state that can't be
