...
name = "Tessara on FastAPI framework on Gunicorn web server"

wsgi_app = "tessara_server.main:app"
...
# Single worker for now. If tessara-server grows in-process state that can't be
